...
public class Facebook {
     ...
     * @param listener
     */
    public final void authorize(final Activity activity,
     ...
     */
    public final void authorize(final Activity activity,
            final String[] permissions, final DialogListener listener) {
     ...
     */
    public final void authorize(final Activity activity,
            final String[] permissions, final int activityCode,
            final DialogListener listener) {
     ...
     * @return
     */
    private boolean startSingleSignOn(final Activity activity,
            final String applicationId, final String[] permissions,
     ...
     */
    private boolean validateAppSignatureForIntent(final Activity activity,
            final Intent intent) {
     ...
     * @param data
     */
    public final void authorizeCallback(final int requestCode,
     ...
     *            ("true" if successful)
     */
    public final String logout(final Context context)
     ...
     */
    public final String request(final Bundle parameters)
            throws MalformedURLException, IOException {
     ...
     * @return JSON string representation of the response
     */
    public final String request(final String graphPath)
            throws MalformedURLException, IOException {
     ...
     * @return JSON string representation of the response
     */
    public final String request(final String graphPath, final Bundle parameters)
            throws MalformedURLException, IOException {
     ...
     *            has completed.
     */
    public final void dialog(final Context context, final String action,
            final DialogListener listener) {
     ...
     */
    public final void dialog(final Context context, final String action,
            final Bundle parameters, final DialogListener listener) {
     ...
     */
    public final void setAccessExpires(final long time) {
        mAccessExpires = time;
    }
     ...
     *            - duration in seconds
     */
    public final void setAccessExpiresIn(final String expiresIn) {
